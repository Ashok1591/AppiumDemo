...
public class GlobalParams {
    ...
    public void initializeGlobalParams() {
        ...
        params.setUDID(System.getProperty("udid", "14f1fd48"));
        params.setDeviceName(System.getProperty("deviceName", "Redmi Note 8"));
        
        if(params.getPlatformName().contains("Android")) {
